...
st.set_page_config(page_title="Compare Kurumlar", layout="wide")
...
st.title("Compare Kurumlar")
st.caption("Select 2 to 5 institutions for side-by-side strategic comparison.")
...
if len(selected_names) < 2:
    st.warning("Select at least two institutions to compare.")
    st.stop()
